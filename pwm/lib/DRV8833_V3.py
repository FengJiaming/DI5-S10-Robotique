...
# Modifications le 05.03.2018 : DRV8833_V3.py
# Version simplifiée ne prenant en compte que le signal PWM de commande d'un moteur sans profil de rampe
...
#   consigne_pwm_moteur : rapport cyclique du signal PWM de commande des moteurs en entrée du DRV8833

    def Cmde_moteur (self, sens, consigne_pwm_moteur) :
        self.DRV883_Sleep_Pin.value(0) # Désactive le driver DRV8833
        if consigne_pwm_moteur < 0.0 :
            consigne_pwm_moteur = 0.0
        elif consigne_pwm_moteur > 1.0 :
            consigne_pwm_moteur = 1.0
